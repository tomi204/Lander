...
const SearchFormMobile = () => {
  ...
  const [guests, setGuests] = useState(query.get("guest"));

  const searchHandler = () => {
    setShowModal(false);
    router.replace(`/?location=${location}&guest=${guests}`);
  };
  ...
  const onChangeSearchHandler = (locationSelected: string, address: number) => {
        ...
        <div className="ml-3 flex-1 text-left overflow-hidden">
          ...
          <span className="block mt-0.5 text-xs font-light text-neutral-500 dark:text-neutral-400 ">
            <span className="line-clamp-1">
              {location ? location : "Anywhere"} • Any week • Add guests
            </span>
          </span>
        </div>
  ...
  return (
    <div className="HeroSearchForm2Mobile">
      ...
      <Transition appear show={showModal} as={Fragment}>
        <Dialog as="div" className="wid relative z-max" onClose={closeModal}>
          <div className="fixed inset-0 bg-white dark:bg-neutral-900">
            <div className="flex h-full">
              ...
              >
                <Dialog.Panel className="relative h-full overflow-hidden flex-1 flex flex-col justify-between here">
                  {showDialog && (
                    <>
                      ...
                      <div className="flex-1 pt-16 px-1.5 sm:px-4 overflow-hidden">
                        <StaySearchForm
                      ...
                      <div className="px-4 py-3 bg-white dark:bg-neutral-900 border-t border-neutral-200 dark:border-neutral-700 flex justify-between">
                        ...
                        <ButtonSubmit onClick={searchHandler} />
                      </div>
                    </>
                  )}
                </Dialog.Panel>
