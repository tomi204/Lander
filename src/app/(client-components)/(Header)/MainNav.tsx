        ...
        <div className="flex  flex-shrink-0  justify-end flex-1 text-neutral-700 dark:text-neutral-100 ">
          {useHydrated() && (
            <div className="flex justify-around space-x-0.5 gap-6 items-center ">
              ...
              <div className="px-10" />
              {!user && (
                <button className="shadow-[inset_0_0_0_2px_#2935db] text-black px-8 py-2 rounded-full tracking-widest uppercase font-bold bg-transparent text-nowrap hover:bg-[#2935db] hover:text-white dark:text-neutral-200 transition duration-200">
