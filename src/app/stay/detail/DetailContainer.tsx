...
const StayDetailContainer: FC<StayDetailContainerProps> = ({ stay }) => {
  ...
  const handleOpenModalImageGallery = (id?: string) => {
    setCurrentImageId(id);
    setShowModalImageGallery(true);
  };

  const handleCloseModalImageGallery = () => {
    setShowModalImageGallery(false);
  };
  ...
  // TODO: add price calculator from backend
  ...
  // TODO: load host information from backend
  ...
  return (
    <div className="nc-ListingStayDetailPage">
      ...
      <main className="relative lg:z-10 mt-11 flex flex-col lg:flex-row ">
        ...
        {/* SIDEBAR */}
        <ReservationComponent stay={stay} />
      </main>
    </div>
  );
};
