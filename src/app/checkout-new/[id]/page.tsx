            ...
            <div className="flex flex-col lg:flex-row gap-8">
              ...
              <div className="w-full lg:w-2/3 space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="border rounded-lg p-4 flex items-center space-x-4">
                        ...
                        <div>
                          ...
                          {/*<p className="text-sm text-gray-500">Expiry 06/2024</p>*/}
                        </div>
                      </div>
                ...
                <div className="space-y-4">
                  ...
                  Don’t worry if the Host has some delay, your funds are blocked until check-in.
                  </p>
                </div>
              ...
              <div className="w-full lg:w-1/3 space-y-6">
                <div className="border rounded-lg overflow-hidden">
                  ...
                  <div className="p-4 space-y-2">
                    ...
                    <p className="text-sm text-gray-500">{stay?.num_rooms|| ""} bedrooms • {stay?.num_bathrooms|| ""} bathrooms </p>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    <div className="flex justify-between">
                      <p>Buyer</p>
                      <p className="font-semibold">0x6867949921fCDdfA14EC3d3Db8456415F0122Ab9</p>
                    </div>
                    <div className="flex justify-between">
                      <p>Seller</p>
                      <p className="font-semibold">0x6867949921fCDdfA14EC3d3Db8456415F0122Ab9</p>
