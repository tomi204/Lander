...
const CryptoBedSeo: Metadata = {
  title: {
    default: 'Lander | Explore your next destination',
    template: '%s | Book Accommodations with ERC20 Tokens',
  },
  description:
    'Lander is the leading platform for booking temporary accommodations using ERC20 tokens. Register with your compatible wallet and discover a new way to travel.',
  applicationName: 'Lander',
  authors: [
    {
      name: 'Lander Team',
